...
`)+`
`+p);const y=A+m+o,S=A+p+a,L=Qa(r,r.VERTEX_SHADER,y),R=Qa(r,r.FRAGMENT_SHADER,S);r.attachShader(g,L),r.attachShader(g,R),t.index0AttributeName!==void 0?r.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(g,0,"position"),r.linkProgram(g);function C(w){if(i.debug.checkShaderErrors){const Z=r.getProgramInfoLog(g).trim(),H=r.getShaderInfoLog(L).trim(),X=r.getShaderInfoLog(R).trim();let Q=!0,k=!0;if(r.getProgramParameter(g,r.LINK_STATUS)===!1)if(Q=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,g,L,R);else{const ie=tl(r,L,"vertex"),V=tl(r,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(g,r.VALIDATE_STATUS)+`
