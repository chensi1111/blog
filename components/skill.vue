<template>
  <div class="skillContainer">
    <div class="title" ref="titleRef" :class="{ move: titleMove }">
      {{ t("skill.title") }}
    </div>
    <div class="subTitle first" :class="{ move: firstMove }">
      {{ t("skill.subTitle.0.name") }}
    </div>
    <div class="iconsContainer" ref="firstRef" :class="{ move: firstMove }">
      <div class="icons" v-for="skill in skills1" :key="skill.name">
        <img :src="`/blog/img/${skill.icon}.png`" />
        <div class="name">{{ skill.name }}</div>
      </div>
    </div>
    <div class="subTitle" :class="{ move: secondMove }">
      {{ t("skill.subTitle.1.name") }}
    </div>
    ...
    <div class="subTitle" :class="{ move: thirdMove }">
      {{ t("skill.subTitle.2.name") }}
    </div>
    ...
    <div class="subTitle" :class="{ move: fourthMove }">
      {{ t("skill.subTitle.3.name") }}
    </div>
    ...
    <div class="subTitle" :class="{ move: fifthMove }">
      {{ t("skill.subTitle.4.name") }}
    </div>
    ...
    <div class="subTitle" :class="{ move: sixthMove }">
      {{ t("skill.subTitle.5.name") }}
    </div>
